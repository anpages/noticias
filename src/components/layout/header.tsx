...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="h-14 border-b border-neutral-200 dark:border-neutral-800 flex items-center justify-between px-3 sm:px-4 shrink-0 bg-white dark:bg-neutral-950 z-20">
